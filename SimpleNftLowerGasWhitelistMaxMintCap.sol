...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("NAME", "SYMBOL") {
    setHiddenMetadataUri("ipfs://QmSMqbQffhTwd3SMwuVTFHhx2aRPrUbsK7G8aMXdwNJJaC/prereveal.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(YourWalletAddress).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
